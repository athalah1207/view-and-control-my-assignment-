...
<head>
  ...
  <style>
    ...
    .produk-card { background: white; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin: 20px auto; width: 60%; }
  </style>
</head>
<body>
  <header><h1>Produk & Layanan</h1></header>
