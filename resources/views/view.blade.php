...
<head>
  ...
  <style>
    ...
    .home-card { background: white; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin: 20px auto; width: 60%; }
  </style>
</head>
<body>
  ...
  <main>
    <div class="home-card">
      <h2>Halo di Halaman Utama!</h2>
      <p>Temukan informasi menarik dan produk terbaik di sini.</p>
    </div>
  </main>
